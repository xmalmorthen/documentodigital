...
namespace scanndoc.classes
{
	static class WaterMark
	{
        ...
        private static string swapdirectory
        {
            get
            {
        ...
        private static string scannfilename
        {
            get
            {
        ...
        public static byte[] generate(byte[] img)
		{            
			//define a string of text to use as the Copyright message
            string marca_texto = Settings.Default.marca_de_gua;

			//create a image object containing the photograph to watermark
            Image imgPhoto = procesa_imagen.ByteArrayToImage(img);
            ...
            Image imgWatermark = Resources.watermark;
			...
			//-------------------------------------------------------
			int[] sizes = new int[]{20,18,16,14,12,10,8,6,4};
			...
			for (int i=0 ;i<7; i++)
			{
				...
				crSize = grPhoto.MeasureString(marca_texto, crFont);
			...
			grPhoto.DrawString(marca_texto,                 //string of text
				crFont,                                   //font
            ...
            byte[] result = procesa_imagen.toByteArray(imgPhoto);
