...
namespace scanndoc.forms
{
    public partial class re_expedientes_tramites : Form
    {
        ...
        private void actualiza_lista_tramites(int? id_expediente)
        {
            try
            {
                lista_tramites = Program.Bd_Exp_Transportes.pa_TramitesNoEnlazadosporExpediente(id_expediente).ToList();
        ...
        private void actualiza_re_expedientes_tramites(int? id_expediente)
        {
            try
            {
                tramitesclasificados = Program.Bd_Exp_Transportes.pa_TramitesporExpediente(id_expediente).ToList();
...
#region botonera
        ...
        private void agregar_registro()
        {
            try 
	        {
                if (valida()) {
                    ...
                    Program.Bd_Exp_Transportes.re_expedientes_tramites.InsertOnSubmit(item);
        ...
        private void eliminar_registro()
        {
            try
            {
                ...
                data_members.re_expedientes_tramites item = Program.Bd_Exp_Transportes.re_expedientes_tramites.SingleOrDefault(query => query.id == id);

                if (item != null)
                {
                    Program.Bd_Exp_Transportes.re_expedientes_tramites.DeleteOnSubmit(item);
                    Program.Bd_Exp_Transportes.SubmitChanges();
