    ...
    public partial class ca_clasificaciontramites : Form
    {
        ...
        private void actualiza_lista() {
            try
            {
                ...
                lista = Program.Bd_Expedientes_Digitales.GetTable<data_members.ca_clasificaciontramites>().ToList();
...
#region botonera
            ...
            try 
	        {
                if (bindingsource.DataSource != null) {
                    ...
                    if (valida())
                    {
                        if (!buscar_si_existe())
                        {
                            Program.Bd_Expedientes_Digitales.ca_clasificaciontramites.InsertOnSubmit(catalogo);
        ...
        private bool buscar_si_existe()
        {
            try
            {
                data_members.ca_clasificaciontramites filtro = Program.Bd_Expedientes_Digitales.ca_clasificaciontramites.SingleOrDefault(query => query.Descripcion.ToString().ToLower() == catalogo.Descripcion.ToString().ToLower());
                if (filtro != null)
                {
        ...
        private void eliminar_registro()
        {
            try
            {
                ...
                {
                    catalogo = (data_members.ca_clasificaciontramites)bindingsource.Current;
                    Program.Bd_Expedientes_Digitales.ca_clasificaciontramites.DeleteOnSubmit(catalogo);
                    Program.Bd_Expedientes_Digitales.SubmitChanges();
