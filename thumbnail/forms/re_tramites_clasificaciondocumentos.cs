...
namespace thumbnail.forms
{
    public partial class re_tramites_clasificaciondocumentos : Form
    {
        ...
        private void actualiza_lista_tramites()
        {
            try
            {
                lista_tramites = Program.Bd_Exp_Transportes.GetTable<data_members.ca_tramites>().ToList();
        ...
        private void actualiza_lista_clasificaciondocumentos(int? id_tramite)
        {
            try
            {
                lista_clasificaciondocumentos = Program.Bd_Exp_Transportes.pa_ClasificacionDocumentosNoEnlazadosporTramite(id_tramite).ToList();
        ...
        private void actualiza_re_tramites_clasificaciondocumentos(int? id_tramite)
        {
            try
            {
                documentosclasificados = Program.Bd_Exp_Transportes.pa_ClasificacionDocumentosporTramite(id_tramite).ToList();
...
#region botonera
        ...
        private void txt_buscar_EditValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                List<thumbnail.data_members.ca_tramites> valores = (from query in lista_tramites
        ...
        private void agregar_registro()
        {
            try 
	        {
                if (valida()) {
                    ...
                    Program.Bd_Exp_Transportes.re_tramites_clasificaciondocumentos.InsertOnSubmit(item);
        ...
        private void txt_buscarcampotrazable_EditValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                List<thumbnail.data_members.pa_ClasificacionDocumentosporTramiteResult> valores = (from query in documentosclasificados
        ...
        private void eliminar_registro()
        {
            try
            {
                ...
                data_members.re_tramites_clasificaciondocumentos item = Program.Bd_Exp_Transportes.re_tramites_clasificaciondocumentos.SingleOrDefault(query => query.id == id);

                if (item != null)
                {
                    Program.Bd_Exp_Transportes.re_tramites_clasificaciondocumentos.DeleteOnSubmit(item);
                    Program.Bd_Exp_Transportes.SubmitChanges();
