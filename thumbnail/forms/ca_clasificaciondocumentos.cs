...
{
    public partial class ca_clasificaciondocumentos : Form
    {
        ...
        private List<data_members.ca_clasificaciondocumentos> lista;
        private data_members.ca_clasificaciondocumentos catalogo;
        ...
        public ca_clasificaciondocumentos(Boolean externo)
        {
            InitializeComponent();
            agregar_externo = externo;
            this.Paint += new PaintEventHandler(ca_clasificaciondocumentos_Paint);
        }

        void ca_clasificaciondocumentos_Paint(object sender, PaintEventArgs e)
        {
...
#region botonera
        ...
        private void btn_Editar_Click(object sender, EventArgs e)
        {
            ...
            catalogo = (data_members.ca_clasificaciondocumentos)bindingsource.Current;
        }
        ...
        private void txt_buscar_EditValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                List<scanndoc.data_members.ca_clasificaciondocumentos> valores = (from query in lista
            ...
            try 
	        {
                if (bindingsource.DataSource != null) {
                    ...
                    if (valida())
                    {
                        if (!buscar_si_existe())
                        {
                            Program.Bd_Expedientes_Digitales.ca_clasificaciondocumentos.InsertOnSubmit(catalogo);
        ...
        private bool buscar_si_existe()
        {
            try
            {
                data_members.ca_clasificaciondocumentos filtro = Program.Bd_Expedientes_Digitales.ca_clasificaciondocumentos.SingleOrDefault(query => query.Descripcion.ToString().ToLower() == catalogo.Descripcion.ToString().ToLower());
                if (filtro != null)
                {
        ...
        private void eliminar_registro()
        {
            try
            {
                ...
                {
                    catalogo = (data_members.ca_clasificaciondocumentos)bindingsource.Current;
                    Program.Bd_Expedientes_Digitales.ca_clasificaciondocumentos.DeleteOnSubmit(catalogo);
                    Program.Bd_Expedientes_Digitales.SubmitChanges();
