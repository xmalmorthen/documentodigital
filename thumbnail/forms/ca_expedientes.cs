...
#region botonera
            ...
            try 
	        {
                if (bindingsource.DataSource != null) {
                    ...
                    if (valida())
                    {
                        if (!buscar_si_existe())
                        {
                            Program.Bd_Expedientes_Digitales.ca_expedientes.InsertOnSubmit(catalogo);
        ...
        private bool buscar_si_existe()
        {
            try
            {
                data_members.ca_expedientes filtro = Program.Bd_Expedientes_Digitales.ca_expedientes.SingleOrDefault(query => query.Descripcion.ToString().ToLower() == catalogo.Descripcion.ToString().ToLower());
                if (filtro != null)
                {
        ...
        private void eliminar_registro()
        {
            try
            {
                ...
                {
                    catalogo = (data_members.ca_expedientes)bindingsource.Current;
                    Program.Bd_Expedientes_Digitales.ca_expedientes.DeleteOnSubmit(catalogo);
                    Program.Bd_Expedientes_Digitales.SubmitChanges();
