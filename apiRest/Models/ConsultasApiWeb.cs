...
namespace apiRest.ModelsApiWeb
{
    ...
    */
    ...
    public class ConsultasApiWeb
    {
        ...
        public IEnumerable<pa_ConsultaTramitesResult> ConsultaTramites(int tipo_busqueda, string campo_trazable, int? id_expediente = null) {
            List<pa_ConsultaTramitesResult> response = bd.pa_ConsultaTramites(tipo_busqueda, campo_trazable, id_expediente).ToList();
